                            ...
                            <div className="portfolio__slider__content__slide">
                                ...
                                <div className="portfolio__slider__content__slide__game-content portfolio__slider__content__slide__game-content--left">
                                    <div className="portfolio__game-presentation">
                                        ...
                                        <p className="portfolio__slide__game-description">It's only you and your father, living in the cold of the mountains, everyday he leaves you alone to hunt and come back with food,but one day he doesn't, what happen to him? you have to find it out, but how will you survive alone?</p>
                                        <button className="portfolio__slide__learn-more-btn">Learn More...</button>
                                    </div>
