...
class Privacy extends React.Component {
    ...
    render(){
        ...
        <div className="privacy">
            ...
            <p>Iter Inferis ("us", "we", or "our") operates the Iter Inferis mobile application (the "Service").</p>
            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our 
                Service and the choices you have associated with that data. Our Privacy Policy  for Iter 
                Inferis is managed through 
            ...
            <ul>
                ...
                <li><strong>Preference Cookies.</strong> 
            ...
            <p>Iter Inferis uses the collected data for various purposes:</p>    
            <ul>
            ...
            <p>Iter Inferis will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h2>Disclosure Of Data</h2>

            <h3>Legal Requirements</h3>
            <p>Iter Inferis may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Iter Inferis</li>
            ...
            <p>We will let you know via email andor a prominent notice on our Service, prior to the change 
            ...
            <ul>
                <li>By email: poisonpixstudios@gmail.com</li>
            </ul>
        </div>
        )
    }
